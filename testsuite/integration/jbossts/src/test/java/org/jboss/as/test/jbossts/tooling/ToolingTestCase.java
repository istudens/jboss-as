...
//        debugInstrumentedClass(instrumentedJMSXAResource, "prepare", "rollback", "commit", "start", "end");
        ...
        probeLog(managementClient);
        List<ModelNode> indoubtTxs = getTxsFromLog(managementClient);
        ...
        log.info("tx type " + getTypeOfTx(managementClient, transactionId));

        List<ModelNode> participants = getParticipantsOfTx(managementClient, transactionId);
        ...
        for (ModelNode participant : participants) {
            ...
            recoverParticipant(managementClient, transactionId, participantId);
        }
        ...
        probeLog(managementClient);
        indoubtTxs = getTxsFromLog(managementClient);
        ...
        participants = getParticipantsOfTx(managementClient, transactionId);
        ...
        for (Property property : getParticipantResources(managementClient, transactionId, participantId)) {
        ...
        deleteTxFromLog(managementClient, transactionId);
...
//        debugInstrumentedClass(instrumentedJMSXAResource, "prepare", "rollback", "commit", "start", "end");
    ...
    private void cleanLog(ManagementClient managementClient) throws IOException, MgmtOperationException {
        probeLog(managementClient);
        List<ModelNode> indoubtTxs = getTxsFromLog(managementClient);
        log.warn("Some unexpected txs in txlog");

        for (ModelNode tx : indoubtTxs) {
            deleteTxFromLog(managementClient, tx.asString());
        }
    ...
    private void probeLog(final ManagementClient managementClient) throws IOException, MgmtOperationException {
    ...
    private List<ModelNode> getTxsFromLog(final ManagementClient managementClient) throws IOException, MgmtOperationException {
        ...
        log.info("operation=" + operation);
        final ModelNode txsFromLog = ManagementOperations.executeOperation(managementClient.getControllerClient(), operation);
        return txsFromLog.asList();
    }

    private String getTypeOfTx(final ManagementClient managementClient, String transactionId) throws IOException, MgmtOperationException {
        ...
        log.info("operation=" + operation);
        final ModelNode txType = ManagementOperations.executeOperation(managementClient.getControllerClient(), operation);
        return txType.asString();
    }

    private List<ModelNode> getParticipantsOfTx(final ManagementClient managementClient, String transactionId) throws IOException, MgmtOperationException {
        ...
        log.info("operation=" + operation);
        final ModelNode participants = ManagementOperations.executeOperation(managementClient.getControllerClient(), operation);
        return participants.asList();
    }

    private List<Property> getParticipantResources(final ManagementClient managementClient, String transactionId, String participantId) throws IOException, MgmtOperationException {
        ...
        operation.get(OP_ADDR).set(address);
        log.info("operation=" + operation);
        final ModelNode resources = ManagementOperations.executeOperation(managementClient.getControllerClient(), operation);
        return resources.asPropertyList();
    }

    private void recoverParticipant(final ManagementClient managementClient, String transactionId, String participantId) throws IOException, MgmtOperationException {
    ...
    private void deleteTxFromLog(final ManagementClient managementClient, String transactionId) throws IOException, MgmtOperationException {
